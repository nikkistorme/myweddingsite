  ...
  return (
    <HomeContainer>
      ...
      <HomeMessage>
        ...
        <p>This means, we're tying the knot soon! In person, our wedding will be extremely small, but we'd be honored to have your virtual attendance at our courthouse ceremony!</p>
        <p>We haven't given up hope to have an in-person celebration some time in the future&mdash;we just don't know when that will be feasible. Until then, we're so excited to share our special day any way we can with the most important people in our lives.</p>
        <p>All our love,</p>
        <p>N & A</p>
      </HomeMessage>
    </HomeContainer>
